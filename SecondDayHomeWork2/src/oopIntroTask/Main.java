	...
	public static void main(String[] args) 
	{
		...
		// COURSES
				Course course1 = new Course
						(1, "Yazýlým Geliþtirici Yetiþtirme Kampý (C# + ANGULAR)", 
						"2 ay sürecek ücretsiz ve profesyonel bir programla, sýfýrdan yazýlým geliþtirme öðreniyoruz.",
						"Ücretsiz","C#");
				
				Course course2 = new Course
						(2, "Yazýlým Geliþtirici Yetiþtirme Kampý (JAVA + REACT)", 
						"2 ay sürecek ücretsiz ve profesyonel bir programla, sýfýrdan yazýlým geliþtirme öðreniyoruz.",
						"Ücretsiz","Java");
				
				Course course3 = new Course
						(3, "Programlamaya Giriþ Ýçin Temel Kurs", 
				...
				courseManager.sendComment(course2, "Kamp çok güzel gidiyor. Çok teþekkürler, emeðinize saðlýk. :)");
				...
				Instructor instructor3 = new Instructor(3, "Nergiz Erdaðý");
